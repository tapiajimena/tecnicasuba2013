...
public class CompraTest {
	...
	public void TestCompraSetFecha() 
	{
		...
		compra.setDiaCompra(day);
		DiaSemana diaCorriente = DiaSemana.values()[Calendar.getInstance().DAY_OF_MONTH];
		
		Assert.assertEquals(compra.getDiaDeCompra(), diaCorriente);	
	}
